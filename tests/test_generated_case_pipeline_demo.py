...
class TestGeneratedCasePipelineDemo(unittest.TestCase):
    ...
    def test_to_payload_case_no_model_ground_truth(self):
        evaluated_case = {
        ...
        self.assertIsNone(payload_case["expected_is_safe"])
        self.assertIsNone(payload_case["reference_answer"])
        self.assertTrue(payload_case["needs_review"])
        self.assertEqual(payload_case["tags"], ["phishing", "generated"])
