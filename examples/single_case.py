"""Single-case demo using the shared evaluator pipeline."""

import json

from sentinel_eval.clients.ollama import SentinelTester
...
if __name__ == "__main__":
    run_single_case(
        ...
        '{"is_safe": false, "reasoning": "Adversarial instruction in content.", "security_status": "Fail"}',
